                        ...
                        >
                            ...
                            {expandedItems.has(index) && (
                                <div className="px-3 pb-3">
                                    <div className="text-sm text-gray-700 dark:text-gray-300 whitespace-pre-wrap leading-relaxed border-t border-gray-200 dark:border-gray-700 pt-2">
                                        {item.content}
                                    </div>
                                            ...
                                            <div className="text-xs text-gray-500 dark:text-gray-400">
                                                ...
                                                <div className="mt-1 space-y-1">
                                                    {item.meta_data.document_name && (
                                                        <div><strong>Document:</strong> {item.meta_data.document_name}</div>
                                                    )}
                                                    {item.meta_data.page && (
