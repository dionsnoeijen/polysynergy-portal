    ...
    return (
        <div className="flex flex-col h-full">
            ...
            <div className="border-b border-sky-500/50 dark:border-white/10 p-2 flex items-center justify-between">
                <h3 className="text-sky-500 dark:text-white/80">Execution History</h3>
                            ...
                            return (
                                <div key={run.run_id} className="border-b border-zinc-700 last:border-b-0">
                                    ...
                                    <button
                                        ...
                                        className={`w-full p-3 text-left hover:bg-zinc-700/50 transition-colors flex items-center justify-between ${
                                    ...
                                    {/* Run Content */}
                                    {isExpanded && (
                                        <div className="px-6 pb-3 bg-zinc-800/50">
                                            <div className="text-xs text-zinc-400 space-y-1">
                                                <div>Run ID: <span className="font-mono text-zinc-300">{run.run_id}</span></div>
                                                <div>Timestamp: <span className="text-zinc-300">{run.timestamp}</span></div>
                                                <div className="pt-2">
                                                    <div className="text-green-400">✓ Historical data loaded</div>
                                                    <div className="text-zinc-500">Node states applied to canvas</div>
                                                </div>
                                            </div>
                                        </div>
                                    )}
