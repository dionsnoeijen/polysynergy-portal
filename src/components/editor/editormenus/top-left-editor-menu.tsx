...
const TopLeftEditorMenu: React.FC = () => {
    ...
    return (
        <div className="bg-zinc-800 bg-opacity-80 border border-white/20 p-2 rounded-full absolute left-5 top-5 flex flex-col items-center justify-center">
            ...
            <div className="flex flex-col items-start justify-center w-full h-full">
                <button
                    ...
                    type="button"
                    className={`w-full text-lg font-semibold ${!hasMockData ? 'text-zinc-600' : 'text-white'} rounded-sm p-2 ${!hasMockData ? 'bg-transparent' : 'bg-sky-500'}`}
