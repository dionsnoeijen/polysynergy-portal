...
const BytesContent: React.FC<BytesContentProps> = ({ logic }) => {
    ...
    return (
        <>
            ...
            <CodeBracketSquareIcon className={`w-4 h-4 ml-1 ${logic.iconColor}`} />
