...
import {BoltIcon, DocumentTextIcon, ForwardIcon} from "@heroicons/react/24/outline";
    ...
    return (
        <div
            ...
            <div className="flex items-center truncate">
                ...
                <ForwardIcon className={`w-4 h-4 ml-1 ${isValueConnected ? 'text-yellow-300 dark:text-yellow-300' : 'text-sky-400 dark:text-slate-400'}`} />
