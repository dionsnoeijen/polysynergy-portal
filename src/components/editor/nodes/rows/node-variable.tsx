...
import NodeContent from '@/components/editor/nodes/rows/components/node-content';
...
const NodeVariablePlaceholder: React.FC<Props> = ({
    variable,
    nodeId,
    onlyIn = false,
    onlyOut = false,
    ...
    return (
        ...
        >
            {(logic) => <NodeContent logic={logic} />}
        </InterpretedVariableContainer>
    );
};

export default NodeVariablePlaceholder;