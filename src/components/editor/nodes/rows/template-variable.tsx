    ...
    return (
        <div
            ...
            <div className="flex items-center truncate">
                ...
                {isValueConnected ? <span className="ml-1"><BoltIcon className={'w-4 h-4 text-orange-800'} /></span> : <span className={`ml-1 ${categorySubTextColor}`}>{variable.value as string}</span>}
            </div>
