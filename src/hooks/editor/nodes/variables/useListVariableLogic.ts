...
export interface ListVariableLogicProps {
...
export const useListVariableLogic = ({
    variable,
    nodeId,
    isOpen,
    isMirror = false,
    ...
    return useMemo(() => {
        ...
        const showToggle = !isValueConnected;
        const shouldShowList = isOpen && Array.isArray(variable.value);
        const listItems = Array.isArray(variable.value) ? (variable.value as string[]) : [];
